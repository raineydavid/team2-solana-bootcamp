...
const EncodesolanaprojectFeature = lazy(() => import('@/components/encodesolanaproject/encodesolanaproject-feature'))
...
export function AppRoutes() {
  ...
  return useRoutes([
    ...
    {
      path: 'encodesolanaproject',
      element: <EncodesolanaprojectFeature />,
    },
  ])
}
